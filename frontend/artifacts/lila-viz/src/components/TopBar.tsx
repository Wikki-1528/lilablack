...
import { Play, BarChart2, Sparkles, ChevronDown, ChevronLeft, ChevronRight } from 'lucide-react';
...
// Build 28 days starting from day-of-week offset 0
          ...
          return (
            <button
              ...
              style={{
                ...
                border: `1px solid ${active ? 'rgba(255,138,0,0.35)' : 'transparent'}`,
                color: active ? '#ff8a00' : 'rgba(255,255,255,0.4)',
